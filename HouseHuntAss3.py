class HouseHunt:
    ...
    def userInput(self):
        ...
        annual_salary = int(input("What is your annual starting salary? "))
        semi_annual_raise = float(input("What is your semi-annual raise(In %)? "))/100
        portion_saved = float(input("What portion of your salary do you save(In %)? "))/100
        return total_cost, annual_salary, portion_saved, semi_annual_raise

    def calculateMonths(self):
        total_cost, annual_salary, portion_saved, semi_annual_raise = self.userInput()
        ...
        while current_savings < down_payment:
            ...
            if months%6 == 0 and months!=0:
                ...
                savings += savings*semi_annual_raise
